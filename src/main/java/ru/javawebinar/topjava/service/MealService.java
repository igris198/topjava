...
public class MealService {
    ...
    @Transactional
    public void update(MealCreatingTo mealCreatingTo, int userId) {
        Meal meal = get(mealCreatingTo.id(), userId);
        Meal updatedMeal = MealsUtil.updateFromTo(meal, mealCreatingTo);
