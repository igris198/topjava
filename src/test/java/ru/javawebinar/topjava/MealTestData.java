...
public class MealTestData {
    ...
    public static final Meal admin30012020averageDate = new Meal(ADMIN_MEAL_ID, LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед админа 30", 1000);
    ...
    public static final Meal userMealMinDate = new Meal(USER_MEAL_ID, LocalDateTime.of(2022, Month.JANUARY, 31, 0, 0), "Обед юзера", 500);
